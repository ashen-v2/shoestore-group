                ...
                <div className="flex items-center space-x-6">
                    ...
                    <Link to="/cart" className="flex flex-col items-center justify-center relative hover:opacity-80 transition-opacity">
                        <div className="relative">
                            ...
                            {cartCount > 0 && (
                                <span className="absolute -top-1.5 -right-2 bg-[#f5d547] text-black text-[10px] font-bold rounded-full h-[18px] w-[18px] flex items-center justify-center border border-white">
                                    {cartCount}
                                </span>
                            )}
                        </div>
