...
const Navbar = ({ onSearch }) => {
    ...
    return (
        <nav className="bg-white border-b border-gray-100 py-3 px-6">
                ...
                <div className="flex items-center space-x-6">
                    <Link to="/cart" className="flex flex-col items-center justify-center relative hover:opacity-80 transition-opacity">
                        <div className="relative">
                            ...
                            <span className="absolute -top-1.5 -right-2 bg-[#f5d547] text-black text-[10px] font-bold rounded-full h-[18px] w-[18px] flex items-center justify-center border border-white">4</span>
                        </div>
                    ...
                    <div className="w-10 h-10 rounded-full overflow-hidden cursor-pointer border border-gray-100 ml-4 drop-shadow-sm">
